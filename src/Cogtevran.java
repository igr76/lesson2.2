public class Cogtevran extends Horward{
    ...
    private void maximum() {
        ...
        for ( int i = 0; i < cogtevran.lenght;i++){
            ...
            summ1 = person.getPower() + person.getDistance() + person.getMind() + person.getWit() + person.getCreativity();
            System.out.println("У " + person.getName() +person.getPower() + person.getDistance() +
                    person.getMind() + person.getWit() + person.getCreativity());
    ...
    private void who(int i,int g) {
        ...
        if (summ1 > person.getPower() + person.getDistance() + person.getMind() + person.getWit() + person.getCreativity()) {
