public class Slizerin extends Horward{
    ...
    private void maximum() {
        ...
        for (int i = 0; i < slizerin.lenght; i++) {
            ...
            summ1 = person.getPower() + person.getDistance() + person.getTrick() + person.getResolute() + person.getAmbitious();
    ...
    private void who(int i,int g) {
        ...
        if (summ1 > person.getPower() + person.getDistance() + person.getTrick() + person.getResolute() + person.getAmbitious()) {
