public class Griffindor extends Horward {
    ...
    private void maximum() {
        ...
        for ( int i = 0; i < griffindor.lenght;i++){
            ...
            summ1 = person.getPower() + person.getDistance() + person.getNobility() +
                    person.getHonor() + person.getBravery();
            System.out.println("У " + person.getName() +person.getPower() + person.getDistance() +
                    person.getNobility() + person.getHonor() + person.getBravery());
    ...
    private void who(int i,int g) {
        ...
        if (summ1 > person.getPower() + person.getDistance() + person.getNobility() +
                person.getHonor() + person.getBravery()) {
